...
#define __COLORS__
   ...
   ║ C or C++ (please not that I am not aware if these codes work in other languages.║
   ║ To learn how to use it please see USAGE.                                        ║
   ║                                                                                 ║
   ║ It was intended to have all 256 color, but since some were repetitive and some  ║
   ║ were hardly ever used I have decided to use only 207 of them.                   ║
   ║                                                                                 ║
