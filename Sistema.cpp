...
void Sistema::establecer_animales_fugados(int cantidad)
{
    animales_fugados = cantidad;
}
...
void recorrido_pasar_tiempo(Animal* animal, int &contador)
{
...
bool Sistema::pasar_tiempo()
{
    int contador = obtener_animales_fugados();
